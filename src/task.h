...
void task_init_tid_bitmask(uint64 *thread_bitmask);
...
threadid *task_system_get_max_tid(task_system *ts);
...
void *task_system_get_thread_scratch(task_system *ts, threadid tid);

bool task_system_use_bg_threads(task_system *ts);
