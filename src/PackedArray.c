...
#error PACKEDARRAY_IMPL_BITS_PER_ITEM undefined
    ...
    defined(PACKEDARRAY_IMPL_UNPACK_CASES)
...
#define PACKEDARRAY_IMPL_BITS_AVAILABLE                                        \
  (32 - ((PACKEDARRAY_IMPL_CASE_I * PACKEDARRAY_IMPL_BITS_PER_ITEM) % 32))
#endif
#ifndef PACKEDARRAY_IMPL_START_BIT
#define PACKEDARRAY_IMPL_START_BIT                                             \
  ((PACKEDARRAY_IMPL_CASE_I * PACKEDARRAY_IMPL_BITS_PER_ITEM) % 32)
#endif
#ifndef PACKEDARRAY_IMPL_MASK
#define PACKEDARRAY_IMPL_MASK                                                  \
  (uint32)((1ULL << PACKEDARRAY_IMPL_BITS_PER_ITEM) - 1)
#endif
...
#elif defined(                                                                 \
    PACKEDARRAY_IMPL_UNPACK_CASES) // #if defined(PACKEDARRAY_IMPL_PACK_CASES)
...
#else // #if defined(PACKEDARRAY_IMPL_PACK_CASES) ||
      // defined(PACKEDARRAY_IMPL_UNPACK_CASES)

void PACKEDARRAY_JOIN(__PackedArray_pack_, PACKEDARRAY_IMPL_BITS_PER_ITEM)(
    uint32 *__restrict out, uint32 offset, const uint32 *__restrict in,
    uint32 count) {
  uint32 startBit;
  uint32 packed;
...
#include PACKEDARRAY_SELF
  ...
  if ((count * PACKEDARRAY_IMPL_BITS_PER_ITEM + startBit) % 32) {
    packed |=
        *out &
        ~((uint32)(1ULL << ((((uint64_t)count *
                                  (uint64_t)PACKEDARRAY_IMPL_BITS_PER_ITEM +
                              startBit - 1) %
                             32) +
                            1)) -
          1);
...
void PACKEDARRAY_JOIN(__PackedArray_unpack_, PACKEDARRAY_IMPL_BITS_PER_ITEM)(
    const uint32 *__restrict in, uint32 offset, uint32 *__restrict out,
    uint32 count) {
  uint32 packed;
  const uint32 *__restrict end;
...
#endif // #if defined(PACKEDARRAY_IMPL_PACK_CASES) ||
       // defined(PACKEDARRAY_IMPL_UNPACK_CASES)
...
void PackedArray_pack(uint32 *a, const uint32 offset, const uint32 *in,
  ...
  switch (bitsPerItem) {
  case 1:
    __PackedArray_pack_1(a, offset, in, count);
    break;
  case 2:
    __PackedArray_pack_2(a, offset, in, count);
    break;
  case 3:
    __PackedArray_pack_3(a, offset, in, count);
    break;
  case 4:
    __PackedArray_pack_4(a, offset, in, count);
    break;
  case 5:
    __PackedArray_pack_5(a, offset, in, count);
    break;
  case 6:
    __PackedArray_pack_6(a, offset, in, count);
    break;
  case 7:
    __PackedArray_pack_7(a, offset, in, count);
    break;
  case 8:
    __PackedArray_pack_8(a, offset, in, count);
    break;
  case 9:
    __PackedArray_pack_9(a, offset, in, count);
    break;
  case 10:
    __PackedArray_pack_10(a, offset, in, count);
    break;
  case 11:
    __PackedArray_pack_11(a, offset, in, count);
    break;
  case 12:
    __PackedArray_pack_12(a, offset, in, count);
    break;
  case 13:
    __PackedArray_pack_13(a, offset, in, count);
    break;
  case 14:
    __PackedArray_pack_14(a, offset, in, count);
    break;
  case 15:
    __PackedArray_pack_15(a, offset, in, count);
    break;
  case 16:
    __PackedArray_pack_16(a, offset, in, count);
    break;
  case 17:
    __PackedArray_pack_17(a, offset, in, count);
    break;
  case 18:
    __PackedArray_pack_18(a, offset, in, count);
    break;
  case 19:
    __PackedArray_pack_19(a, offset, in, count);
    break;
  case 20:
    __PackedArray_pack_20(a, offset, in, count);
    break;
  case 21:
    __PackedArray_pack_21(a, offset, in, count);
    break;
  case 22:
    __PackedArray_pack_22(a, offset, in, count);
    break;
  case 23:
    __PackedArray_pack_23(a, offset, in, count);
    break;
  case 24:
    __PackedArray_pack_24(a, offset, in, count);
    break;
  case 25:
    __PackedArray_pack_25(a, offset, in, count);
    break;
  case 26:
    __PackedArray_pack_26(a, offset, in, count);
    break;
  case 27:
    __PackedArray_pack_27(a, offset, in, count);
    break;
  case 28:
    __PackedArray_pack_28(a, offset, in, count);
    break;
  case 29:
    __PackedArray_pack_29(a, offset, in, count);
    break;
  case 30:
    __PackedArray_pack_30(a, offset, in, count);
    break;
  case 31:
    __PackedArray_pack_31(a, offset, in, count);
    break;
  case 32:
    __PackedArray_pack_32(a, offset, in, count);
    break;
  }
}
...
void PackedArray_unpack(const uint32 *a, const uint32 offset, uint32 *out,
  ...
  switch (bitsPerItem) {
  case 1:
    __PackedArray_unpack_1(a, offset, out, count);
    break;
  case 2:
    __PackedArray_unpack_2(a, offset, out, count);
    break;
  case 3:
    __PackedArray_unpack_3(a, offset, out, count);
    break;
  case 4:
    __PackedArray_unpack_4(a, offset, out, count);
    break;
  case 5:
    __PackedArray_unpack_5(a, offset, out, count);
    break;
  case 6:
    __PackedArray_unpack_6(a, offset, out, count);
    break;
  case 7:
    __PackedArray_unpack_7(a, offset, out, count);
    break;
  case 8:
    __PackedArray_unpack_8(a, offset, out, count);
    break;
  case 9:
    __PackedArray_unpack_9(a, offset, out, count);
    break;
  case 10:
    __PackedArray_unpack_10(a, offset, out, count);
    break;
  case 11:
    __PackedArray_unpack_11(a, offset, out, count);
    break;
  case 12:
    __PackedArray_unpack_12(a, offset, out, count);
    break;
  case 13:
    __PackedArray_unpack_13(a, offset, out, count);
    break;
  case 14:
    __PackedArray_unpack_14(a, offset, out, count);
    break;
  case 15:
    __PackedArray_unpack_15(a, offset, out, count);
    break;
  case 16:
    __PackedArray_unpack_16(a, offset, out, count);
    break;
  case 17:
    __PackedArray_unpack_17(a, offset, out, count);
    break;
  case 18:
    __PackedArray_unpack_18(a, offset, out, count);
    break;
  case 19:
    __PackedArray_unpack_19(a, offset, out, count);
    break;
  case 20:
    __PackedArray_unpack_20(a, offset, out, count);
    break;
  case 21:
    __PackedArray_unpack_21(a, offset, out, count);
    break;
  case 22:
    __PackedArray_unpack_22(a, offset, out, count);
    break;
  case 23:
    __PackedArray_unpack_23(a, offset, out, count);
    break;
  case 24:
    __PackedArray_unpack_24(a, offset, out, count);
    break;
  case 25:
    __PackedArray_unpack_25(a, offset, out, count);
    break;
  case 26:
    __PackedArray_unpack_26(a, offset, out, count);
    break;
  case 27:
    __PackedArray_unpack_27(a, offset, out, count);
    break;
  case 28:
    __PackedArray_unpack_28(a, offset, out, count);
    break;
  case 29:
    __PackedArray_unpack_29(a, offset, out, count);
    break;
  case 30:
    __PackedArray_unpack_30(a, offset, out, count);
    break;
  case 31:
    __PackedArray_unpack_31(a, offset, out, count);
    break;
  case 32:
    __PackedArray_unpack_32(a, offset, out, count);
    break;
  }
}
