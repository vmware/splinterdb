...
buffer_handle *
platform_buffer_create(size_t length, platform_heap_handle heap_handle);
...
platform_status
platform_mutex_init(platform_mutex *mu, platform_heap_id heap_id);

platform_status
platform_mutex_destroy(platform_mutex *mu);

platform_status
platform_spinlock_init(platform_spinlock *lock, platform_heap_id heap_id);
