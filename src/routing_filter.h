...
platform_status routing_filter_add(cache *cc, routing_config *cfg,
                                   ...
                                   uint64 num_new_fingerprints, uint16 value);

platform_status routing_filter_lookup(cache *cc, routing_config *cfg,
                                      routing_filter *filter, const char *key,
                                      uint64 *found_values);

static inline uint16 routing_filter_get_next_value(uint64 found_values,
                                                   uint16 last_value) {
...
static inline bool routing_filter_is_value_found(uint64 found_values,
                                                 uint16 value) {
...
static inline void routing_filter_ctxt_init(routing_async_ctxt *ctxt,     // OUT
