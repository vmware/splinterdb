...
static inline uint64 splinter_next_addr(splinter_handle *spl,
                                        page_handle *node);
static inline int splinter_key_compare(splinter_handle *spl, const char *key1,
                                       const char *key2);
static inline page_handle *splinter_node_get(splinter_handle *spl, uint64 addr);
static inline void splinter_node_unget(splinter_handle *spl,
                                       page_handle **node);
static inline void splinter_node_claim(splinter_handle *spl,
                                       page_handle **node);
static inline void splinter_node_unclaim(splinter_handle *spl,
                                         page_handle *node);
static inline void splinter_node_lock(splinter_handle *spl, page_handle *node);
static inline void splinter_node_unlock(splinter_handle *spl,
                                        page_handle *node);
uint64 splinter_alloc(splinter_handle *spl, uint64 height);
static inline char *splinter_get_pivot(splinter_handle *spl, page_handle *node,
                                       uint16 pivot_no);
static inline splinter_pivot_data *splinter_get_pivot_data(splinter_handle *spl,
                                                           page_handle *node,
                                                           uint16 pivot_no);
static inline uint16 splinter_find_pivot(splinter_handle *spl,
                                         page_handle *node, char *key,
                                         lookup_type comp);
platform_status splinter_add_pivot(splinter_handle *spl, page_handle *parent,
                                   page_handle *child, uint16 pivot_no);
static inline uint16 splinter_num_children(splinter_handle *spl,
                                           page_handle *node);
static inline uint16 splinter_num_pivot_keys(splinter_handle *spl,
                                             page_handle *node);
static inline void splinter_inc_num_pivot_keys(splinter_handle *spl,
                                               page_handle *node);
static inline char *splinter_max_key(splinter_handle *spl, page_handle *node);
void splinter_update_num_tuples(splinter_handle *spl, page_handle *node,
                                uint16 branch_no);
void splinter_pivot_recount_num_tuples(splinter_handle *spl, page_handle *node,
                                       uint64 pivot_no);
static inline uint16 splinter_pivot_branch_count(splinter_handle *spl,
                                                 page_handle *node,
                                                 splinter_pivot_data *pdata);
bool splinter_pivot_needs_count_flush(splinter_handle *spl, page_handle *node,
                                      splinter_pivot_data *pdata);
static inline uint64 splinter_pivot_tuples_in_branch(splinter_handle *spl,
                                                     page_handle *node,
                                                     uint16 pivot_no,
                                                     uint16 branch_no);
static inline bool splinter_has_vacancy(splinter_handle *spl, page_handle *node,
                                        uint16 num_new_branches);
static inline uint16 splinter_bundle_no_add(splinter_handle *spl, uint16 start,
                                            uint16 end);
static inline uint16 splinter_bundle_no_sub(splinter_handle *spl, uint16 start,
                                            uint16 end);
static inline splinter_bundle *
splinter_get_bundle(splinter_handle *spl, page_handle *node, uint16 bundle_no);
static inline uint16 splinter_get_new_bundle(splinter_handle *spl,
                                             page_handle *node);
static inline uint16 splinter_bundle_start_branch(splinter_handle *spl,
                                                  page_handle *node,
                                                  splinter_bundle *bundle);
static inline uint16 splinter_start_bundle(splinter_handle *spl,
                                           page_handle *node);
static inline uint16 splinter_inc_start_bundle(splinter_handle *spl,
                                               page_handle *node);
static inline uint16 splinter_end_bundle(splinter_handle *spl,
                                         page_handle *node);
static inline uint16 splinter_bundle_clear_subbundles(splinter_handle *spl,
                                                      page_handle *node,
                                                      splinter_bundle *bundle);
static inline uint16 splinter_subbundle_no_add(splinter_handle *spl,
                                               uint16 start, uint16 end);
static inline uint16 splinter_subbundle_no_sub(splinter_handle *spl,
                                               uint16 start, uint16 end);
static inline uint16 splinter_end_subbundle(splinter_handle *spl,
                                            page_handle *node);
static inline uint16 splinter_end_sb_filter(splinter_handle *spl,
                                            page_handle *node);
static inline splinter_branch *splinter_get_branch(splinter_handle *spl,
                                                   page_handle *node, uint32 k);
static inline splinter_branch *splinter_get_new_branch(splinter_handle *spl,
                                                       page_handle *node);
static inline uint16 splinter_start_branch(splinter_handle *spl,
                                           page_handle *node);
static inline uint16 splinter_end_branch(splinter_handle *spl,
                                         page_handle *node);
static inline uint16 splinter_start_frac_branch(splinter_handle *spl,
                                                page_handle *node);
static inline void splinter_set_start_frac_branch(splinter_handle *spl,
                                                  page_handle *node,
                                                  uint16 branch_no);
static inline uint16 splinter_branch_count(splinter_handle *spl,
                                           page_handle *node);
static inline bool splinter_branch_valid(splinter_handle *spl,
                                         page_handle *node, uint64 branch_no);
static inline bool splinter_branch_live(splinter_handle *spl, page_handle *node,
                                        uint64 branch_no);
static inline bool splinter_branch_live_for_pivot(splinter_handle *spl,
                                                  page_handle *node,
                                                  uint64 branch_no,
                                                  uint16 pivot_no);
static inline bool splinter_branch_is_whole(splinter_handle *spl,
                                            page_handle *node,
                                            uint64 branch_no);
splinter_bundle *splinter_flush_into_bundle(splinter_handle *spl,
                                            page_handle *parent,
                                            page_handle *child,
                                            splinter_pivot_data *pdata,
                                            splinter_compact_bundle_req *req);
void splinter_replace_bundle_branches(splinter_handle *spl, page_handle *node,
                                      splinter_branch *new_branch,
                                      splinter_compact_bundle_req *req);
static inline uint16 splinter_branch_no_add(splinter_handle *spl,
                                            uint16 branch_no, uint16 offset);
static inline uint16 splinter_branch_no_sub(splinter_handle *spl,
                                            uint16 branch_no, uint16 offset);
static inline void splinter_dec_ref(splinter_handle *spl,
                                    splinter_branch *branch, bool is_memtable);
static inline void splinter_zap_branch_range(splinter_handle *spl,
                                             splinter_branch *branch,
                                             const char *start_key,
                                             const char *end_key,
                                             page_type type);
static inline void splinter_inc_intersection(splinter_handle *spl,
                                             splinter_branch *branch,
                                             const char *key, bool is_memtable);
void splinter_memtable_flush_virtual(void *arg, uint64 generation);
platform_status splinter_memtable_insert(splinter_handle *spl, char *key,
                                         char *data);
void splinter_bundle_build_filters(void *arg, void *scratch);
static inline void splinter_inc_filter(splinter_handle *spl,
                                       routing_filter *filter);
static inline void splinter_dec_filter(splinter_handle *spl,
                                       routing_filter *filter);
void splinter_compact_bundle(void *arg, void *scratch);
int splinter_flush(splinter_handle *spl, page_handle *parent,
                   splinter_pivot_data *pdata, bool is_space_rec);
int splinter_flush_fullest(splinter_handle *spl, page_handle *node);
static inline bool splinter_needs_split(splinter_handle *spl,
                                        page_handle *node);
int splinter_split_index(splinter_handle *spl, page_handle *parent,
                         page_handle *child, uint64 pivot_no);
void splinter_split_leaf(splinter_handle *spl, page_handle *parent,
                         page_handle *leaf, uint16 child_idx);
int splinter_split_root(splinter_handle *spl, page_handle *root);
void splinter_print(splinter_handle *spl);
void splinter_print_node(splinter_handle *spl, uint64 addr,
                         platform_stream_handle stream);
void splinter_print_locked_node(splinter_handle *spl, page_handle *node,
                                platform_stream_handle stream);
static void splinter_btree_skiperator_init(
    splinter_handle *spl, splinter_btree_skiperator *skip_itor,
    page_handle *node, uint16 branch_idx, data_type data_type,
...
void splinter_btree_skiperator_deinit(splinter_handle *spl,
 ...
 *-----------------------------------------------------------------------------
 */
void splinter_set_super_block(splinter_handle *spl, bool is_checkpoint,
                              bool is_dismount, bool is_create) {
  uint64 super_addr;
  ...
  super->checksum = platform_checksum128(
      super, sizeof(splinter_super_block) - sizeof(checksum128),
...
void splinter_release_super_block(splinter_handle *spl,
                                  page_handle *super_page) {
  cache_unget(spl->cc, super_page);
}
...
static inline uint16 splinter_height(splinter_handle *spl, page_handle *node) {
  splinter_trunk_hdr *hdr = (splinter_trunk_hdr *)node->data;
  return hdr->height;
}

static inline uint16 splinter_tree_height(splinter_handle *spl) {
...
uint64 splinter_trunk_hdr_size() { return sizeof(splinter_trunk_hdr); }
...
static inline uint16 splinter_logical_branch_count(splinter_handle *spl,
                                                   page_handle *node) {
  splinter_trunk_hdr *hdr = (splinter_trunk_hdr *)node->data;
  // whole branches
  uint16 num_branches =
...
static inline bool splinter_node_is_full(splinter_handle *spl,
                                         page_handle *node) {
  uint64 num_tuples = 0;
...
static inline void splinter_set_next_addr(splinter_handle *spl,
                                          page_handle *node, uint64 addr) {
  splinter_trunk_hdr *hdr = (splinter_trunk_hdr *)node->data;
  hdr->next_addr = addr;
}

bool splinter_for_each_node(splinter_handle *spl, node_fn func, void *arg) {
  page_handle *root = splinter_node_get(spl, spl->root_addr);
...
static inline btree_config *splinter_btree_config(splinter_handle *spl) {
...
static inline page_handle *splinter_node_get(splinter_handle *spl,
                                             uint64 addr) {
  return cache_get(spl->cc, addr, TRUE, PAGE_TYPE_TRUNK);
}

static inline cache_async_result
splinter_node_get_async(splinter_handle *spl, uint64 addr,
                        splinter_async_ctxt *ctxt) {
  return cache_get_async(spl->cc, addr, PAGE_TYPE_TRUNK, &ctxt->cache_ctxt);
}

static inline void splinter_node_async_done(splinter_handle *spl,
                                            splinter_async_ctxt *ctxt) {
...
void splinter_dealloc(splinter_handle *spl, uint64 addr) {
...
static inline bool splinter_branch_in_range(splinter_handle *spl,
                                            uint16 branch_no, uint16 start,
                                            uint16 end) {
...
static inline void splinter_set_pivot(splinter_handle *spl, page_handle *node,
                                      uint16 pivot_no, const char *pivot_key) {
...
static inline void splinter_set_initial_pivots(splinter_handle *spl,
                                               page_handle *node,
                                               const char *min_key,
                                               const char *max_key) {
...
UNUSED_FUNCTION()
static inline char *splinter_min_key(splinter_handle *spl, page_handle *node) {
...
static inline uint64 splinter_pivot_generation(splinter_handle *spl,
                                               page_handle *node) {
  splinter_trunk_hdr *hdr = (splinter_trunk_hdr *)node->data;
  return hdr->pivot_generation;
}

static inline uint64 splinter_inc_pivot_generation(splinter_handle *spl,
                                                   page_handle *node) {
  splinter_trunk_hdr *hdr = (splinter_trunk_hdr *)node->data;
  return hdr->pivot_generation++;
}

uint64 splinter_pivot_size(splinter_handle *spl) {
  return splinter_key_size(spl) + sizeof(splinter_pivot_data);
}

uint64 splinter_pivot_message_size() { return sizeof(splinter_pivot_data); }
...
static inline void splinter_set_pivot_data_new_root(splinter_handle *spl,
                                                    page_handle *node,
                                                    uint64 child_addr) {
...
static inline void splinter_copy_pivot_data_from_pred(splinter_handle *spl,
                                                      page_handle *node,
                                                      uint16 pivot_no,
                                                      uint64 child_addr) {
  debug_assert(splinter_height(spl, node) != 0);
...
static inline uint16 splinter_pivot_start_branch(splinter_handle *spl,
                                                 page_handle *node,
                                                 uint16 pivot_no) {
  splinter_pivot_data *pdata = splinter_get_pivot_data(spl, node, pivot_no);
...
static inline uint64 splinter_generation(splinter_handle *spl,
                                         page_handle *node) {
  splinter_trunk_hdr *hdr = (splinter_trunk_hdr *)node->data;
  return hdr->generation;
}

static inline void splinter_inc_generation(splinter_handle *spl,
                                           page_handle *node) {
  splinter_trunk_hdr *hdr = (splinter_trunk_hdr *)node->data;
  hdr->generation++;
}
 ...
 * Used by find_pivot
 */
static inline uint32 lowerbound(uint32 size) {
  if (size <= 1)
    return 0;
 ...
 * Used by find_pivot
 */
static inline void splinter_update_lowerbound(uint16 *lo, uint16 *mid, int cmp,
                                              lookup_type comp) {
  switch (comp) {
  case less_than:
...
static inline void splinter_shift_pivots(splinter_handle *spl,
                                         page_handle *node, uint16 pivot_no,
                                         uint16 shift) {
  debug_assert(splinter_height(spl, node) != 0);
...
void splinter_add_pivot_new_root(splinter_handle *spl, page_handle *parent,
                                 page_handle *child) {
  const char *pivot_key = splinter_get_pivot(spl, child, 0);
...
uint64 splinter_pivot_num_tuples(splinter_handle *spl, page_handle *node,
                                 uint16 pivot_no) {
  splinter_pivot_data *pdata = splinter_get_pivot_data(spl, node, pivot_no);
  return pdata->num_tuples;
}

void splinter_pivot_set_num_tuples(splinter_handle *spl, page_handle *node,
                                   uint16 pivot_no, uint64 num_tuples) {
  splinter_pivot_data *pdata = splinter_get_pivot_data(spl, node, pivot_no);
 ...
 */
static inline uint64
splinter_pivot_whole_branch_count(splinter_handle *spl, page_handle *node,
                                  splinter_pivot_data *pdata) {
  splinter_trunk_hdr *hdr = (splinter_trunk_hdr *)node->data;
  if (!splinter_branch_is_whole(spl, node, pdata->start_branch))
    return 0;
  return splinter_branch_no_sub(spl, hdr->start_frac_branch,
                                pdata->start_branch);
}
 ...
 */
static inline uint16 splinter_pivot_bundle_count(splinter_handle *spl,
                                                 page_handle *node,
                                                 splinter_pivot_data *pdata) {
  splinter_trunk_hdr *hdr = (splinter_trunk_hdr *)node->data;
...
splinter_pivot_subbundle_count(splinter_handle *spl, page_handle *node,
                               splinter_pivot_data *pdata) {
  splinter_trunk_hdr *hdr = (splinter_trunk_hdr *)node->data;
...
static inline uint16
splinter_pivot_start_subbundle(splinter_handle *spl, page_handle *node,
                               splinter_pivot_data *pdata) {
  if (pdata->start_bundle == splinter_end_bundle(spl, node)) {
    return splinter_end_subbundle(spl, node);
    ;
  }
  splinter_bundle *bundle = splinter_get_bundle(spl, node, pdata->start_bundle);
  return bundle->start_subbundle;
}

static inline uint16
splinter_pivot_end_subbundle_for_lookup(splinter_handle *spl, page_handle *node,
                                        splinter_pivot_data *pdata) {
 ...
 */
static inline uint16
splinter_pivot_logical_branch_count(splinter_handle *spl, page_handle *node,
                                    splinter_pivot_data *pdata) {
 ...
 * branch count.
 */
static inline bool splinter_pivot_needs_flush(splinter_handle *spl,
                                              page_handle *node,
                                              splinter_pivot_data *pdata) {
...
static inline uint64 splinter_pivot_tuples_in_btree(splinter_handle *spl,
                                                    page_handle *node,
                                                    uint16 pivot_no,
                                                    uint64 root_addr) {
...
static inline uint64 splinter_pivot_tuples_in_branch(splinter_handle *spl,
  ...
  return splinter_pivot_tuples_in_btree(spl, node, pivot_no, branch->root_addr);
}

__attribute__((unused)) static inline uint64
splinter_pivot_tuples_in_branch_slow(splinter_handle *spl, page_handle *node,
                                     uint16 pivot_no, uint16 branch_no) {
  splinter_branch *branch = splinter_get_branch(spl, node, branch_no);
  char *min_key = splinter_get_pivot(spl, node, pivot_no);
  char *max_key = splinter_get_pivot(spl, node, pivot_no + 1);
 ...
 */
// FIXME: [tjiaheng 2020-07-23] do we want to also include range_num_tuples
void splinter_leaf_count_num_tuples(splinter_handle *spl, page_handle *node,
 ...
 */
static inline void splinter_reset_start_branch(splinter_handle *spl,
                                               page_handle *node) {
  splinter_trunk_hdr *hdr = (splinter_trunk_hdr *)node->data;
...
static inline void splinter_pivot_clear(splinter_handle *spl, page_handle *node,
                                        splinter_pivot_data *pdata) {
  splinter_trunk_hdr *hdr = (splinter_trunk_hdr *)node->data;
 ...
 */
static inline uint16 splinter_pdata_to_pivot_index(splinter_handle *spl,
                                                   page_handle *node,
                                                   splinter_pivot_data *pdata) {
 ...
 * root split.
 */
uint64 splinter_find_node(splinter_handle *spl, char *key, uint64 height) {
...
static inline splinter_subbundle *splinter_get_subbundle(splinter_handle *spl,
                                                         page_handle *node,
                                                         uint16 subbundle_no) {
  splinter_trunk_hdr *hdr = (splinter_trunk_hdr *)node->data;
...
static inline uint16 splinter_subbundle_no(splinter_handle *spl,
                                           page_handle *node,
...
splinter_get_new_subbundle(splinter_handle *spl, page_handle *node,
                           uint16 num_filters) {
  splinter_trunk_hdr *hdr = (splinter_trunk_hdr *)node->data;
...
static inline routing_filter *splinter_get_sb_filter(splinter_handle *spl,
                                                     page_handle *node,
                                                     uint16 filter_no) {
  splinter_trunk_hdr *hdr = (splinter_trunk_hdr *)node->data;
...
static inline uint16 splinter_start_sb_filter(splinter_handle *spl,
                                              page_handle *node) {
  splinter_trunk_hdr *hdr = (splinter_trunk_hdr *)node->data;
...
static inline uint16 splinter_subbundle_filter_count(splinter_handle *spl,
                                                     page_handle *node,
                                                     splinter_subbundle *sb) {
  return splinter_subbundle_no_sub(spl, sb->end_filter, sb->start_filter);
}

static inline uint16 splinter_bundle_filter_count(splinter_handle *spl,
                                                  page_handle *node,
                                                  splinter_bundle *bundle) {
...
static inline uint16 splinter_bundle_start_filter(splinter_handle *spl,
                                                  page_handle *node,
                                                  splinter_bundle *bundle) {
...
static inline uint16 splinter_bundle_end_filter(splinter_handle *spl,
                                                page_handle *node,
                                                splinter_bundle *bundle) {
...
static inline routing_filter *splinter_subbundle_filter(splinter_handle *spl,
                                                        page_handle *node,
                                                        splinter_subbundle *sb,
                                                        uint16 filter_off) {
...
splinter_subbundle_branch_count(splinter_handle *spl, page_handle *node,
                                splinter_subbundle *sb) {
...
static inline uint16 splinter_start_subbundle_for_lookup(splinter_handle *spl,
                                                         page_handle *node) {
 ...
 */
static inline void splinter_leaf_remove_bundles_except(splinter_handle *spl,
                                                       page_handle *node,
                                                       uint16 bundle_no) {
  debug_assert(splinter_height(spl, node) == 0);
  splinter_trunk_hdr *hdr = (splinter_trunk_hdr *)node->data;
 ...
 */
static inline uint16
splinter_leaf_rebundle_all_branches(splinter_handle *spl, page_handle *node,
  ...
  if (splinter_branch_is_whole(spl, node, splinter_start_branch(spl, node))) {
    splinter_subbundle *sb = splinter_leaf_get_new_subbundle_at_head(spl, node);
 ...
 */
static inline uint16 splinter_bundle_end_branch(splinter_handle *spl,
                                                page_handle *node,
                                                splinter_bundle *bundle) {
 ...
 */
static inline uint16 splinter_bundle_branch_count(splinter_handle *spl,
                                                  page_handle *node,
                                                  splinter_bundle *bundle) {
  return splinter_branch_no_sub(
      spl, splinter_bundle_end_branch(spl, node, bundle),
      splinter_bundle_start_branch(spl, node, bundle));
}

static inline uint16 splinter_bundle_subbundle_count(splinter_handle *spl,
                                                     page_handle *node,
                                                     splinter_bundle *bundle) {
  return splinter_subbundle_no_sub(spl, bundle->end_subbundle,
 ...
 */
static inline uint16 splinter_bundle_count(splinter_handle *spl,
                                           page_handle *node) {
  splinter_trunk_hdr *hdr = (splinter_trunk_hdr *)node->data;
 ...
 */
static inline uint16 splinter_subbundle_count(splinter_handle *spl,
                                              page_handle *node) {
  splinter_trunk_hdr *hdr = (splinter_trunk_hdr *)node->data;
  return splinter_subbundle_no_sub(spl, hdr->end_subbundle,
                                   hdr->start_subbundle);
 ...
 */
static inline bool splinter_bundle_live(splinter_handle *spl, page_handle *node,
                                        uint16 bundle_no) {
  splinter_trunk_hdr *hdr = (splinter_trunk_hdr *)node->data;
 ...
 * FALSE otherwise.
 */
static inline bool splinter_bundle_valid(splinter_handle *spl,
                                         page_handle *node, uint16 bundle_no) {
  splinter_trunk_hdr *hdr = (splinter_trunk_hdr *)node->data;
  return splinter_bundle_no_sub(spl, bundle_no, hdr->start_bundle) <=
         splinter_bundle_no_sub(spl, hdr->end_bundle, hdr->start_bundle);
}
 ...
 */
static inline bool splinter_bundle_live_for_pivot(splinter_handle *spl,
                                                  page_handle *node,
                                                  uint16 bundle_no,
                                                  uint16 pivot_no) {
  debug_assert(pivot_no < splinter_num_children(spl, node));
...
static inline void splinter_reset_start_frac_branch(splinter_handle *spl,
                                                    page_handle *node) {
  if (splinter_bundle_count(spl, node) == 0) {
    ...
    uint16 start_frac_branch = splinter_bundle_start_branch(spl, node, bundle);
    splinter_set_start_frac_branch(spl, node, start_frac_branch);
  }
}

static inline void splinter_clear_bundle(splinter_handle *spl,
                                         page_handle *node, uint16 bundle_no) {
...
static inline void
splinter_tuples_in_bundle(splinter_handle *spl, page_handle *node,
                          splinter_bundle *bundle,
...
static inline void
splinter_pivot_add_bundle_num_tuples(splinter_handle *spl, page_handle *node,
                                     splinter_bundle *bundle,
...
static inline void splinter_bundle_inc_pivot_rc(splinter_handle *spl,
                                                page_handle *node,
                                                splinter_bundle *bundle) {
  uint16 num_children = splinter_num_children(spl, node);
  cache *cc = spl->cc;
...
static inline splinter_branch *splinter_get_new_branch(splinter_handle *spl,
                                                       page_handle *node) {
  splinter_trunk_hdr *hdr = (splinter_trunk_hdr *)node->data;
  splinter_branch *new_branch = splinter_get_branch(spl, node, hdr->end_branch);
  hdr->end_branch = splinter_branch_no_add(spl, hdr->end_branch, 1);
  debug_assert(hdr->end_branch != hdr->start_branch);
  return new_branch;
}

static inline uint16 splinter_branch_no(splinter_handle *spl, page_handle *node,
                                        splinter_branch *branch) {
...
splinter_branch_valid(splinter_handle *spl, page_handle *node,
                      uint64 branch_no) {
  splinter_trunk_hdr *hdr = (splinter_trunk_hdr *)node->data;
  return splinter_branch_no_sub(spl, branch_no, hdr->start_branch) <=
...
static inline uint64 splinter_process_generation_to_pos(
    splinter_handle *spl, splinter_compact_bundle_req *req, uint64 generation) {
  uint64 pos = 0;
...
void splinter_replace_bundle_branches(splinter_handle *spl, page_handle *node,
    ...
    *new_branch = *repl_branch;
    ...
    for (uint16 pivot_no = 0; pivot_no < num_children; pivot_no++) {
      if (!splinter_bundle_live_for_pivot(spl, node, bundle_no, pivot_no)) {
        const char *start_key = splinter_get_pivot(spl, node, pivot_no);
        const char *end_key = splinter_get_pivot(spl, node, pivot_no + 1);
        splinter_zap_branch_range(spl, new_branch, start_key, end_key,
                                  PAGE_TYPE_BRANCH);
      }
    }
  }
  ...
  for (uint16 branch_no = bundle_end_branch; branch_no != hdr->end_branch;
       branch_no = splinter_branch_no_add(spl, branch_no, 1)) {
    uint16 dst_branch_no = splinter_branch_no_sub(spl, branch_no, branch_diff);
  ...
  if (repl_branch == NULL) {
    ...
    for (uint16 filter_no = splinter_bundle_start_filter(spl, node, bundle);
         ...
         filter_no = splinter_subbundle_no_add(spl, filter_no, 1)) {
      routing_filter *old_filter = splinter_get_sb_filter(spl, node, filter_no);
...
static inline void splinter_inc_branch_range(splinter_handle *spl,
                                             splinter_branch *branch,
                                             const char *start_key,
                                             const char *end_key) {
  if (branch->root_addr) {
    btree_inc_range(spl->cc, &spl->cfg.btree_cfg, branch->root_addr, start_key,
                    end_key);
  }
}
...
static inline void splinter_zap_branch_range(splinter_handle *spl,
  ...
  platform_assert(0 || (1 && start_key == NULL && end_key == NULL) ||
                  (1 && type != PAGE_TYPE_MEMTABLE && start_key != NULL));
  if (branch->root_addr) {
    btree_zap_range(spl->cc, &spl->cfg.btree_cfg, branch->root_addr, start_key,
                    end_key, PAGE_TYPE_BRANCH);
  }
...
static inline bool splinter_btree_lookup(splinter_handle *spl,
                                         splinter_branch *branch,
                            ...
                            btree_async_ctxt *ctxt)  // IN
{
  ...
  btree_config *const cfg = &spl->cfg.btree_cfg;
  data_config *data_cfg = spl->cfg.data_cfg;
  cache_async_result res = btree_lookup_async_with_ref(
      cc, cfg, branch->root_addr, &node, key, &data_temp, &local_found, ctxt);
...
memtable *splinter_try_get_memtable(splinter_handle *spl, uint64 generation) {
 ...
 */
memtable *splinter_get_memtable(splinter_handle *spl, uint64 generation) {
  // FIXME: [aconway 2020-09-01] change to cfg
  uint64 memtable_idx = generation % SPLINTER_NUM_MEMTABLES;
  memtable *mt = &spl->mt_ctxt->mt[memtable_idx];
...
static inline void splinter_memtable_inc_ref(splinter_handle *spl,
                                             uint64 mt_gen) {
  memtable *mt = splinter_get_memtable(spl, mt_gen);
  allocator_inc_refcount(spl->al, mt->root_addr);
}

void splinter_memtable_dec_ref(splinter_handle *spl, uint64 generation) {
  memtable *mt = splinter_get_memtable(spl, generation);
 ...
 */
static void splinter_memtable_iterator_init(
    splinter_handle *spl, btree_iterator *itor, uint64 root_addr,
    const char *min_key, const char *max_key, bool is_live, bool inc_refcount) {
  if (inc_refcount) {
...
static void splinter_memtable_iterator_deinit(splinter_handle *spl,
                                              btree_iterator *itor,
                                              uint64 mt_gen,
                                              bool dec_refcount) {
 ...
 */
static memtable *splinter_memtable_compact_and_build_filter(
    splinter_handle *spl, uint64 generation, const threadid tid) {
  ...
  splinter_memtable_iterator_init(spl, &btree_itor, memtable_root_addr, min_key,
                                  NULL, FALSE, FALSE);
  btree_pack_req req;
  ...
  platform_status rc = routing_filter_add(
      spl->cc, &spl->cfg.leaf_filter_cfg, spl->heap_id, &empty_filter,
      &cmt->filter, cmt->req->fp_arr, req.num_tuples, 0);
 ...
 */
static inline bool splinter_try_start_incorporate(splinter_handle *spl,
                                                  uint64 generation) {
  ...
  // return TRUE;
  should_start = memtable_try_transition(mt, MEMTABLE_STATE_COMPACTED,
...
static inline bool splinter_try_continue_incorporate(splinter_handle *spl,
...
static void splinter_memtable_incorporate(splinter_handle *spl,
                                          uint64 generation,
                                          const threadid tid) {
  ...
  *filter = cmt->filter;
  ...
  splinter_pivot_add_bundle_num_tuples(spl, root, bundle,
                                       req->output_pivot_count);
  ...
  *filter = cmt->filter;
  ...
  memtable_transition(mt, MEMTABLE_STATE_INCORPORATING,
...
static void splinter_memtable_flush_internal(splinter_handle *spl,
                                             uint64 generation) {
  const threadid tid = platform_get_tid();
...
static void splinter_memtable_flush_internal_virtual(void *arg, void *scratch) {
...
void splinter_memtable_flush(splinter_handle *spl, uint64 generation) {
  splinter_compacted_memtable *cmt =
      splinter_get_compacted_memtable(spl, generation);
  cmt->mt_args.spl = spl;
...
static inline uint64
splinter_memtable_root_addr_for_lookup(splinter_handle *spl, uint64 generation,
                                       bool *is_compacted) {
 ...
 *    if *found, the data can be found in `data`.
 */
static bool splinter_memtable_lookup(splinter_handle *spl, uint64 generation,
                                     char *key, char *data, bool *found) {
...
static inline routing_config *splinter_routing_cfg(splinter_handle *spl,
                                                   bool is_leaf) {
  // if (is_leaf) {
...
static inline void splinter_prepare_build_filter(
    splinter_handle *spl, splinter_compact_bundle_req *req, page_handle *node) {
  uint16 height = splinter_height(spl, node);
...
static inline void splinter_process_generation_to_fp_bounds(
    splinter_handle *spl, splinter_compact_bundle_req *req, uint64 generation,
    uint32 *fp_start, uint32 *fp_end) {
  uint64 pos = 0;
...
static inline void splinter_build_filters(splinter_handle *spl,
                                          splinter_compact_bundle_req *req) {
  threadid tid;
  uint64 filter_build_start;
  uint16 height;
  ...
  for (uint64 pos = 0; pos < SPLINTER_MAX_PIVOTS; pos++) {
    ...
    platform_status rc =
        routing_filter_add(spl->cc, filter_cfg, spl->heap_id, &old_filter,
                           &new_filter, fp_arr, num_fingerprints, value);
...
static inline void splinter_replace_routing_filter(
    splinter_handle *spl, splinter_compact_bundle_req *req, page_handle *node) {
  uint16 num_children = splinter_num_children(spl, node);
  for (uint16 pivot_no = 0; pivot_no < num_children; pivot_no++) {
    splinter_pivot_data *pdata = splinter_get_pivot_data(spl, node, pivot_no);
    ...
    ZERO_CONTENTS(&req->filter[pos]);
    uint64 num_tuples_to_reclaim = splinter_pivot_tuples_to_reclaim(spl, pdata);
...
static cache_async_result
splinter_filter_lookup_async(splinter_handle *spl, routing_config *cfg,
                             routing_filter *filter, char *key,
                             uint64 *found_values, routing_async_ctxt *ctxt) {
 ...
 */
static inline bool splinter_room_to_flush(splinter_handle *spl,
                                          page_handle *parent,
                                          page_handle *child,
                                          splinter_pivot_data *pdata) {
  ...
  return child_branches + flush_branches <
             spl->cfg.hard_max_branches_per_node &&
 ...
 */
bool splinter_flush(splinter_handle *spl, page_handle *parent,
                    splinter_pivot_data *pdata, bool is_space_rec) {
 ...
 * does.
 */
bool splinter_flush_fullest(splinter_handle *spl, page_handle *node) {
...
UNUSED_FUNCTION()
static inline uint64 branch_choose_root(splinter_branch *branch,
                                        data_type type) {
  switch (type) {
...
static inline btree_config *splinter_choose_btree_config(splinter_handle *spl,
                                                         data_type type) {
  switch (type) {
  case data_type_point:
    return &spl->cfg.btree_cfg;
...
void save_pivots_to_compact_bundle_scratch(
    ...
    compact_bundle_scratch *scratch) // IN/OUT
{
  ...
  for (uint32 i = 0; i < num_pivot_keys; i++) {
    memmove(&scratch->saved_pivot_keys[i].k, splinter_get_pivot(spl, node, i),
...
void splinter_branch_iterator_init(splinter_handle *spl, btree_iterator *itor,
                                   splinter_branch *branch, const char *min_key,
                                   const char *max_key, bool do_prefetch,
                                   data_type data_type, bool should_inc_ref) {
  cache *cc = spl->cc;
  btree_config *btree_cfg = data_type == data_type_point
                                ? &spl->cfg.btree_cfg
                                : &spl->cfg.range_btree_cfg;
  uint64 root_addr = data_type == data_type_point ? branch->root_addr
                                                  : branch->range_root_addr;
  if (root_addr != 0 && should_inc_ref) {
    btree_inc_range(cc, btree_cfg, root_addr, min_key, max_key);
  }
  btree_iterator_init(cc, btree_cfg, itor, root_addr, PAGE_TYPE_BRANCH, min_key,
                      max_key, do_prefetch, FALSE, 0, data_type);
}

void splinter_branch_iterator_deinit(splinter_handle *spl, btree_iterator *itor,
                                     bool should_dec_ref) {
  if (itor->root_addr == 0) {
    return;
  }
  ...
  btree_iterator_deinit(itor);
  if (should_dec_ref) {
    btree_zap_range(cc, btree_cfg, itor->root_addr, min_key, max_key,
                    PAGE_TYPE_BRANCH);
  }
}
  ...
  for (uint16 i = min_pivot_no; i < max_pivot_no + 1; i++) {
    ...
    if (!branch_valid && iterator_started) {
      ...
      splinter_branch_iterator_init(spl, btree_itor, &skip_itor->branch,
                                    pivot_min_key, pivot_max_key, TRUE,
                                    data_type, TRUE);
...
static inline void splinter_branch_pack_req_init(splinter_handle *spl,
                                                 iterator *itor,
                                                 branch_pack_req *req) {
  ...
  btree_pack_req_init(&req->range_req, spl->cc, &spl->cfg.range_btree_cfg, itor,
                      spl->cfg.max_tuples_per_node, NULL, 0, spl->heap_id);
}

__attribute__((unused)) static inline void
splinter_branch_pack_req_deinit(splinter_handle *spl, branch_pack_req *req) {
  // only point tree uses filter for now
...
void splinter_compact_bundle(void *arg, void *scratch_buf) {
  platform_status rc;
  ...
  save_pivots_to_compact_bundle_scratch(spl, node, data_type_point, scratch);
  ...
  rc = merge_iterator_create(
      spl->heap_id, spl->cfg.data_cfg, &spl->cfg.range_data_cfg, num_trees,
      itor_arr, resolve_updates_and_discard_deletes,
  ...
  do {
    ...
    if (splinter_bundle_live(spl, node, req->bundle_no)) {
      if (point_req->num_tuples != 0) {
        ...
        // This may create an empty branch, set the empty one to null before
        // getting in loop?
    ...
    if (1 && num_replacements != 0 && point_req->num_tuples != 0 &&
...
bool splinter_flush_node(splinter_handle *spl, uint64 addr, void *arg) {
...
int splinter_split_index(splinter_handle *spl, page_handle *parent,
  ...
  for (uint16 filter_no = start_filter; filter_no != end_filter;
       filter_no = splinter_subbundle_no_add(spl, filter_no, 1)) {
    routing_filter *filter = splinter_get_sb_filter(spl, left_node, filter_no);
...
__attribute__((unused)) static inline uint64
splinter_pivot_estimate_unique_keys(splinter_handle *spl, page_handle *node,
                                    splinter_pivot_data *pdata) {
  ...
  for (uint16 sb_filter_no = splinter_start_sb_filter(spl, node);
    ...
    routing_filter *sb_filter = splinter_get_sb_filter(spl, node, sb_filter_no);
...
void splinter_split_leaf(splinter_handle *spl, page_handle *parent,
  ...
  memmove(scratch->pivot[0], splinter_min_key(spl, leaf),
          splinter_key_size(spl));
  ...
  if (target_num_leaves != 1) {
    ...
    for (uint64 branch_offset = 0; branch_offset < num_branches;
      ...
      btree_iterator_init(spl->cc, &spl->cfg.btree_cfg,
    ...
    platform_status rc = merge_iterator_create(
        spl->heap_id, spl->cfg.data_cfg, &spl->cfg.range_data_cfg, num_branches,
        rough_itor, FALSE, FALSE, FALSE, &rough_merge_itor);
    platform_assert_status_ok(rc);
    ...
    for (num_leaves = 0; !at_end; num_leaves++) {
      ...
      if (!at_end) {
        ...
        memmove(scratch->pivot[num_leaves + 1], curr_key,
                splinter_key_size(spl));
      }
    }
  ...
  memmove(scratch->pivot[num_leaves], splinter_max_key(spl, leaf),
          splinter_key_size(spl));
  ...
  for (uint16 leaf_no = 0; leaf_no < num_leaves; leaf_no++) {
    ...
    // adjust min key
    memmove(splinter_get_pivot(spl, new_leaf, 0), scratch->pivot[leaf_no],
            splinter_key_size(spl));
    // adjust max key
    memmove(splinter_get_pivot(spl, new_leaf, 1), scratch->pivot[leaf_no + 1],
            splinter_key_size(spl));
    ...
    if (leaf_no != 0) {
      ...
      for (uint16 branch_no = splinter_start_branch(spl, new_leaf);
           ...
           branch_no = splinter_branch_no_add(spl, branch_no, 1)) {
        splinter_branch *branch = splinter_get_branch(spl, new_leaf, branch_no);
      ...
      splinter_bundle *bundle = splinter_get_bundle(spl, new_leaf, bundle_no);
      uint16 start_filter = splinter_bundle_start_filter(spl, new_leaf, bundle);
...
void splinter_range_iterator_get_curr(iterator *itor, char **key, char **data,
                                      data_type *type);
...
splinter_range_iterator_init(splinter_handle *spl,
                             splinter_range_iterator *range_itor, char *min_key,
                             char *max_key, uint64 num_tuples) {
  range_itor->spl = spl;
  ...
  for (uint64 mt_gen = range_itor->memtable_start_gen;
       mt_gen != range_itor->memtable_end_gen; mt_gen--) {
  ...
  for (uint16 h = height; h > 0; h--) {
    uint16 pivot_no =
        splinter_find_pivot(spl, node, range_itor->min_key, less_than_or_equal);
    debug_assert(pivot_no < splinter_num_children(spl, node));
    splinter_pivot_data *pdata = splinter_get_pivot_data(spl, node, pivot_no);
    ...
    for (uint16 branch_offset = 0;
      ...
      range_itor->meta_page[range_itor->num_branches] = btree_blind_inc(
  ...
  // leaf btrees
  for (uint16 branch_offset = 0;
       branch_offset != splinter_branch_count(spl, node); branch_offset++) {
    uint16 branch_no = splinter_branch_no_sub(
        spl, splinter_end_branch(spl, node), branch_offset + 1);
    range_itor->branch[range_itor->num_branches] =
        *splinter_get_branch(spl, node, branch_no);
  ...
  char *rebuild_key = !range_itor->has_max_key ||
                              splinter_key_compare(
                                  spl, splinter_max_key(spl, node), max_key) < 0
  ...
  for (uint64 i = 0; i < range_itor->num_branches; i++) {
    ...
    if (range_itor->compacted[branch_no]) {
      bool do_prefetch =
          range_itor->compacted[branch_no] && num_tuples > SPLINTER_PREFETCH_MIN
              ? TRUE
              : FALSE;
      splinter_branch_iterator_init(
          spl, btree_itor, branch, range_itor->min_key,
          range_itor->local_max_key, do_prefetch, data_type_point, FALSE);
    } else {
      uint64 mt_root_addr = branch->root_addr;
      bool is_live = branch_no == 0;
      splinter_memtable_iterator_init(
          spl, btree_itor, mt_root_addr, range_itor->min_key,
          range_itor->local_max_key, is_live, FALSE);
    }
  ...
  platform_status rc = merge_iterator_create(
      ...
      range_itor->num_branches, range_itor->itor, TRUE, TRUE, TRUE,
  ...
  if (at_end) {
    ...
    if (1 &&
      ...
      rc =
          splinter_range_iterator_init(spl, range_itor, range_itor->rebuild_key,
                                       max_key, range_itor->num_tuples);
      if (!SUCCESS(rc)) {
        return rc;
      }
      iterator_at_end(&range_itor->merge_itor->super, &at_end);
...
platform_status splinter_range_iterator_advance(iterator *itor) {
  ...
  if (at_end) {
    ...
    if (range_itor->has_max_key) {
      rc = splinter_range_iterator_init(
          range_itor->spl, range_itor, range_itor->rebuild_key,
          range_itor->max_key, range_itor->num_tuples);
    } else {
      rc = splinter_range_iterator_init(range_itor->spl, range_itor,
                                        range_itor->rebuild_key, NULL,
                                        range_itor->num_tuples);
    }
    if (!SUCCESS(rc)) {
      return rc;
...
void splinter_range_iterator_deinit(splinter_range_iterator *range_itor) {
  ...
  for (uint64 i = 0; i < range_itor->num_branches; i++) {
    ...
    if (range_itor->compacted[i]) {
      ...
      btree_blind_zap(spl->cc, &spl->cfg.btree_cfg, meta_page,
                      PAGE_TYPE_BRANCH);
    } else {
 ...
 */
splinter_pivot_data *
splinter_find_pivot_from_generation(splinter_handle *spl, page_handle *leaf,
...
platform_status splinter_compact_leaf(splinter_handle *spl, page_handle *leaf) {
  const threadid tid = platform_get_tid();
  // FIXME: [aconway 2020-06-19] This scratch lookup feels a bit dirty
...
bool splinter_should_reclaim_space(splinter_handle *spl) {
...
platform_status splinter_reclaim_space(splinter_handle *spl) {
...
bool splinter_filter_lookup(splinter_handle *spl, page_handle *node,
                            routing_filter *filter, routing_config *cfg,
                            uint16 start_branch, const char *key, char *data,
                            bool *found) {
  uint16 height;
  threadid tid;
  if (spl->cfg.use_stats) {
...
bool splinter_compacted_subbundle_lookup(splinter_handle *spl,
                                         page_handle *node,
                                         splinter_subbundle *sb,
                                         const char *key, char *data,
                                         bool *found) {
  ...
  for (uint16 filter_no = 0; filter_no != filter_count; filter_no++) {
    ...
    platform_status rc = routing_filter_lookup(
        spl->cc, &spl->cfg.leaf_filter_cfg, filter, key, &found_values);
    platform_assert_status_ok(rc);
    if (found_values) {
      ...
      if (local_found) {
        if (data_message_class(spl->cfg.data_cfg, data) !=
            MESSAGE_TYPE_UPDATE) {
          return FALSE;
        }
      } else if (spl->cfg.use_stats) {
...
bool splinter_bundle_lookup(splinter_handle *spl, page_handle *node,
                            splinter_bundle *bundle, char *key, char *data,
                            bool *found) {
  ...
  for (uint16 sb_off = 0; sb_off != sb_count; sb_off++) {
    ...
    if (sb->state == SB_STATE_COMPACTED) {
      should_continue =
          splinter_compacted_subbundle_lookup(spl, node, sb, key, data, found);
    } else {
      routing_filter *filter = splinter_subbundle_filter(spl, node, sb, 0);
      ...
      should_continue = splinter_filter_lookup(
          spl, node, filter, cfg, sb->start_branch, key, data, found);
    }
    if (!should_continue) {
      return should_continue;
    }
...
bool splinter_pivot_lookup(splinter_handle *spl, page_handle *node,
                           splinter_pivot_data *pdata, char *key, char *data,
                           bool *found) {
...
platform_status splinter_lookup(splinter_handle *spl, char *key, char *data,
                                bool *found) {
  data_config *data_cfg = spl->cfg.data_cfg;
  message_type type;
  ...
  *found = FALSE;
  ...
  platform_assert(!*found ||
                  data_message_class(data_cfg, data) == MESSAGE_TYPE_UPDATE);
  if (*found) {
...
static inline void splinter_async_set_state(splinter_async_ctxt *ctxt,
...
static void splinter_trunk_async_callback(cache_async_ctxt *cache_ctxt) {
  splinter_async_ctxt *ctxt =
...
static void splinter_filter_async_callback(routing_async_ctxt *filter_ctxt) {
  splinter_async_ctxt *ctxt =
...
static void splinter_btree_async_callback(btree_async_ctxt *btree_ctxt) {
  splinter_async_ctxt *ctxt =
...
cache_async_result splinter_lookup_async(splinter_handle *spl,      // IN
                                         char *key,                 // IN
                                         char *data,                // OUT
                                         bool *found,               // OUT
  ...
  do {
    ...
    case async_state_get_root_reentrant: {
      ...
      case async_no_reqs:
        ...
        //                         __FILE__, __LINE__, platform_get_tid(),
        //                         ctxt);
        /*
    ...
    case async_state_filter_lookup_reentrant: {
      ...
      res =
          splinter_filter_lookup_async(spl, filter_cfg, ctxt->filter, key,
    ...
    case async_state_btree_lookup_start: {
      ...
      case async_lookup_state_pivot:
        ...
        branch_no =
            splinter_branch_no_add(spl, ctxt->pdata->start_branch, ctxt->value);
        break;
      case async_lookup_state_subbundle:
        debug_assert(ctxt->sb != NULL);
        ctxt->value =
        ...
        branch_no =
            splinter_branch_no_add(spl, ctxt->sb->start_branch, ctxt->value);
...
platform_status splinter_range(splinter_handle *spl, char *start_key,
                               uint64 num_tuples, uint64 *tuples_returned,
                               char *out) {
  splinter_range_iterator *range_itor = TYPED_MALLOC(spl->heap_id, range_itor);
  platform_status rc = splinter_range_iterator_init(spl, range_itor, start_key,
                                                    NULL, num_tuples);
  if (!SUCCESS(rc)) {
  ...
  for (*tuples_returned = 0; *tuples_returned < num_tuples && !at_end;
    ...
    char *next_key = out + *tuples_returned * (splinter_key_size(spl) +
...
splinter_handle *splinter_create(splinter_config *cfg, allocator *al, cache *cc,
                                 task_system *ts, allocator_root_id id,
  ...
  if (spl->cfg.use_stats) {
    ...
    for (uint64 i = 0; i < MAX_THREADS; i++) {
      platform_status rc;
      rc = platform_histo_create(spl->heap_id, LATENCYHISTO_SIZE + 1,
...
splinter_handle *splinter_mount(splinter_config *cfg, allocator *al, cache *cc,
                                task_system *ts, allocator_root_id id,
                                platform_heap_id hid) {
  splinter_handle *spl = TYPED_FLEXIBLE_STRUCT_ZALLOC(
      hid, spl, compacted_memtable, SPLINTER_NUM_MEMTABLES);
...
void splinter_deinit(splinter_handle *spl) {
...
bool splinter_node_destroy(splinter_handle *spl, uint64 addr, void *arg) {
  page_handle *node = splinter_node_get(spl, addr);
  splinter_node_claim(spl, &node);
  splinter_node_lock(spl, node);
  uint16 num_children = splinter_num_children(spl, node);
...
bool splinter_verify_node(splinter_handle *spl, page_handle *node) {
  ...
  for (uint16 pivot_no = 0; pivot_no < num_children; pivot_no++) {
    ...
    for (uint16 branch_no = pivot_start_branch;
      ...
      //      pivot_no, branch_no);
      count += splinter_pivot_tuples_in_branch(spl, node, pivot_no, branch_no);
    }
    // if (count != slow_count) {
  ...
  for (uint16 pivot_no = 0; pivot_no < num_children; pivot_no++) {
    ...
    if (!splinter_bundle_live(spl, node, pdata->start_bundle)) {
      if (1 && pdata->start_branch != splinter_end_branch(spl, node) &&
        ...
        platform_error_log(
            "splinter_verify: pivot start bundle doesn't match start branch\n");
        platform_error_log("addr: %lu\n", addr);
        goto out;
      }
    } else {
      ...
      if (pdata->start_branch != sb->start_branch) {
        if (!splinter_branch_in_range(spl, pdata->start_branch,
                                      ...
                                      sb->start_branch)) {
          platform_error_log("splinter_verify: pivot start branch out of order "
                             "with bundle start branch\n");
          platform_error_log("addr: %lu\n", addr);
          goto out;
        }
        if (pdata->start_bundle != splinter_start_bundle(spl, node)) {
          platform_error_log("splinter_verify: pivot start bundle incoherent "
                             "with start branch\n");
          platform_error_log("addr: %lu\n", addr);
          goto out;
        }
...
bool splinter_verify_node_with_neighbors(splinter_handle *spl,
                                         page_handle *node) {
  bool is_valid = FALSE;
  uint64 addr = node->disk_addr;
...
bool splinter_verify_node_and_neighbors(splinter_handle *spl, uint64 addr,
                                        void *arg) {
  page_handle *node = splinter_node_get(spl, addr);
...
bool splinter_node_space_use(splinter_handle *spl, uint64 addr, void *arg) {
    ...
    for (uint16 pivot_no = 0; pivot_no < num_pivot_keys; pivot_no++) {
      if (1 && pivot_no != num_children &&
        ...
        if (start_key != NULL) {
          ...
          uint64 bytes_used_in_branch_range = btree_space_use_in_range(
...
void splinter_print_locked_node(splinter_handle *spl, page_handle *node,
  ...
  platform_log_stream(
      ...
      node->disk_addr, splinter_next_addr(spl, node), height,
      splinter_generation(spl, node), splinter_pivot_generation(spl, node));
  platform_log_stream("|-------------------------------------------------------"
                      "------------------------------|\n");
  ...
  for (uint16 pivot_no = 0; pivot_no < splinter_num_pivot_keys(spl, node);
       pivot_no++) {
    char key_string[128];
    splinter_key_to_string(spl, splinter_get_pivot(spl, node, pivot_no),
                           key_string);
    splinter_pivot_data *pdata = splinter_get_pivot_data(spl, node, pivot_no);
    if (pivot_no == splinter_num_pivot_keys(spl, node) - 1) {
      ...
      platform_log_stream("| %24s | %12lu | %12lu | %11lu | %4ld | %5lu |\n",
                          key_string, pdata->addr, pdata->filter.addr,
                          pdata->num_tuples, pdata->srq_idx, pdata->generation);
    }
  }
  platform_log_stream("|-------------------------------------------------------"
                      "------------------------------|\n");
  platform_log_stream("|                              BRANCHES AND "
                      "[SUB]BUNDLES                              |\n");
  platform_log_stream("|-------------------------------------------------------"
                      "------------------------------|\n");
  platform_log_stream("|   # |  point addr  |  range addr  | filter1 addr | "
                      "filter2 addr | filter3 addr |    |\n");
  ...
  for (uint16 branch_no = start_branch; branch_no != end_branch;
    ...
    for (uint16 sb_no = start_sb; sb_no != end_sb;
      ...
      if (branch_no == sb->start_branch) {
        uint16 filter_count = splinter_subbundle_filter_count(spl, node, sb);
        platform_log_stream(
            "|     |  -- %scomp subbundle %2u --  | %12lu | %12lu | %12lu | %s "
            "|\n",
            sb->state == SB_STATE_COMPACTED ? "" : "un", sb_no,
            0 < filter_count ? splinter_subbundle_filter(spl, node, sb, 0)->addr
                             : 0,
            1 < filter_count ? splinter_subbundle_filter(spl, node, sb, 1)->addr
                             : 0,
            2 < filter_count ? splinter_subbundle_filter(spl, node, sb, 2)->addr
                             : 0,
            3 < filter_count ? " *" : "  ");
      }
    }
...
void splinter_print_subtree(splinter_handle *spl, uint64 addr,
                            platform_stream_handle stream) {
...
void splinter_print_memtable(splinter_handle *spl,
                             platform_stream_handle stream) {
...
void splinter_print_insertion_stats(splinter_handle *spl) {
  ...
  platform_histo_create(spl->heap_id, LATENCYHISTO_SIZE + 1,
                        latency_histo_buckets, &insert_lat_accum);
  platform_histo_create(spl->heap_id, LATENCYHISTO_SIZE + 1,
                        latency_histo_buckets, &update_lat_accum);
  platform_histo_create(spl->heap_id, LATENCYHISTO_SIZE + 1,
                        latency_histo_buckets, &delete_lat_accum);
  ...
  for (thr_i = 0; thr_i < MAX_THREADS; thr_i++) {
    ...
    for (h = 0; h <= height; h++) {
      ...
      if (spl->stats[thr_i].flush_time_max_ns[h] >
        ...
        global->flush_time_max_ns[h] = spl->stats[thr_i].flush_time_max_ns[h];
      }
      ...
      global->compactions_aborted_flushed[h] +=
          spl->stats[thr_i].compactions_aborted_flushed[h];
      global->compactions_aborted_leaf_split[h] +=
          spl->stats[thr_i].compactions_aborted_leaf_split[h];
      global->compactions_discarded_flushed[h] +=
          spl->stats[thr_i].compactions_discarded_flushed[h];
      global->compactions_discarded_leaf_split[h] +=
          spl->stats[thr_i].compactions_discarded_leaf_split[h];
      ...
      if (spl->stats[thr_i].compaction_max_tuples[h] >
          global->compaction_max_tuples[h]) {
        global->compaction_max_tuples[h] =
            spl->stats[thr_i].compaction_max_tuples[h];
      }
      global->compaction_time_ns[h] += spl->stats[thr_i].compaction_time_ns[h];
      global->compaction_time_wasted_ns[h] +=
          spl->stats[thr_i].compaction_time_wasted_ns[h];
      global->compaction_pack_time_ns[h] +=
          spl->stats[thr_i].compaction_pack_time_ns[h];
      ...
      global->root_compaction_time_ns +=
      ...
      global->space_rec_tuples_reclaimed[h] +=
          spl->stats[thr_i].space_rec_tuples_reclaimed[h];
    ...
    global->memtable_flush_wait_time_ns +=
    ...
    if (spl->stats[thr_i].root_flush_time_max_ns >
      ...
      global->root_flush_time_max_ns = spl->stats[thr_i].root_flush_time_max_ns;
    }
    global->root_flush_wait_time_ns +=
        spl->stats[thr_i].root_flush_wait_time_ns;
    ...
    global->leaf_splits_leaves_created +=
        spl->stats[thr_i].leaf_splits_leaves_created;
    ...
    if (spl->stats[thr_i].leaf_split_max_time_ns >
      ...
      global->leaf_split_max_time_ns = spl->stats[thr_i].leaf_split_max_time_ns;
    }
  ...
  platform_log("---------------------------------------------------------------"
               "------------------------------------------\n");
  platform_log("  height | avg wait time (ns) | avg flush time (ns) | max "
               "flush time (ns) | full flushes | count flushes |\n");
  platform_log("---------|--------------------|---------------------|----------"
               "-----------|--------------|---------------|\n");
  ...
  avg_flush_wait_time =
      num_flushes == 0 ? 0 : global->memtable_flush_wait_time_ns / num_flushes;
  avg_flush_time =
      num_flushes == 0 ? 0 : global->memtable_flush_time_ns / num_flushes;
  ...
  avg_flush_wait_time =
      num_flushes == 0 ? 0 : global->root_flush_wait_time_ns / num_flushes;
  avg_flush_time =
      num_flushes == 0 ? 0 : global->root_flush_time_ns / num_flushes;
  platform_log("    root | %18lu | %19lu | %19lu | %12lu | %13lu |\n",
               avg_flush_wait_time, avg_flush_time,
               global->root_flush_time_max_ns, global->root_full_flushes,
               global->root_count_flushes);

  for (h = 1; h < height; h++) {
    rev_h = height - h;
    num_flushes = global->full_flushes[rev_h] + global->count_flushes[rev_h];
    avg_flush_wait_time =
        num_flushes == 0 ? 0 : global->flush_wait_time_ns[rev_h] / num_flushes;
    avg_flush_time =
        num_flushes == 0 ? 0 : global->flush_time_ns[rev_h] / num_flushes;
    platform_log("%8u | %18lu | %19lu | %19lu | %12lu | %13lu |\n", rev_h,
                 avg_flush_wait_time, avg_flush_time,
                 global->flush_time_max_ns[rev_h], global->full_flushes[rev_h],
                 global->count_flushes[rev_h]);
  }
  platform_log("---------------------------------------------------------------"
               "------------------------------------------\n");
  platform_log("\n");
  ...
  platform_log(
      ...
      "------------------------------------------------------------------\n");
  platform_log(
      "  height | compactions | avg setup time (ns) | time / tuple (ns) | avg "
      "tuples | max tuples | max time (ns) | empty | aborted | discarded |\n");
  platform_log(
      "---------|-------------|---------------------|-------------------|------"
      "------|------------|---------------|-------|---------|-----------|\n");

  avg_setup_time = global->root_compactions == 0
                       ? 0
                       : (global->root_compaction_time_ns -
                          global->root_compaction_pack_time_ns) /
                             global->root_compactions;
  avg_compaction_tuples =
      global->root_compactions == 0
          ? 0
          : global->root_compaction_tuples / global->root_compactions;
  pack_time_per_tuple = global->root_compaction_tuples == 0
                            ? 0
                            : global->root_compaction_pack_time_ns /
                                  global->root_compaction_tuples;
  platform_log("    root | %11lu | %19lu | %17lu | %10lu | %10lu | %13lu | "
               "%5lu | %2lu | %2lu | %3lu | %3lu |\n",
  ...
  for (h = 1; h <= height; h++) {
    rev_h = height - h;
    avg_setup_time = global->compactions[rev_h] == 0
                         ? 0
                         : (global->compaction_time_ns[rev_h] +
                            global->compaction_time_wasted_ns[rev_h] -
                            global->compaction_pack_time_ns[rev_h]) /
                               global->compactions[rev_h];
    avg_compaction_tuples =
        global->compactions[rev_h] == 0
            ? 0
            : global->compaction_tuples[rev_h] / global->compactions[rev_h];
    pack_time_per_tuple = global->compaction_tuples[rev_h] == 0
                              ? 0
                              : global->compaction_pack_time_ns[rev_h] /
                                    global->compaction_tuples[rev_h];
    platform_log(
        "%8u | %11lu | %19lu | %17lu | %10lu | %10lu | %13lu | %5lu | %2lu | "
        "%2lu | %3lu | %3lu |\n",
        ...
        global->compactions_aborted_flushed[rev_h],
        global->compactions_aborted_leaf_split[rev_h],
        global->compactions_discarded_flushed[rev_h],
        global->compactions_discarded_leaf_split[rev_h]);
  }
  platform_log(
      "------------------------------------------------------------------------"
      "------------------------------------------------------------------\n");
  ...
  if (global->leaf_splits == 0) {
    ...
    avg_leaves_created =
        init_fraction(global->leaf_splits_leaves_created + global->leaf_splits,
                      global->leaf_splits);
  }
  uint64 leaf_avg_split_time =
      global->leaf_splits == 0
          ? 0
  ...
  platform_log("---------------------------------------------------------------"
               "----------------\n");
  platform_log(" leaf splits | avg leaves created | avg split time (ns) | max "
               "split time (ns) |\n");
  platform_log("-------------|--------------------|---------------------|------"
               "---------------|\n");
  ...
  platform_log("---------------------------------------------------------------"
               "------------------\n");
  platform_log("  height |   built | avg tuples | avg build time (ns) | "
               "build_time / tuple (ns) |\n");
  platform_log("---------|---------|------------|---------------------|--------"
               "-----------------|\n");

  avg_filter_tuples =
      global->root_filters_built == 0
          ? 0
  ...
  filter_time_per_tuple =
      global->root_filter_tuples == 0
          ? 0
          : global->root_filter_time_ns / global->root_filter_tuples;

  platform_log("    root | %7lu | %10lu | %19lu | %23lu |\n",
               global->root_filters_built, avg_filter_tuples, avg_filter_time,
               filter_time_per_tuple);
  for (h = 1; h <= height; h++) {
    rev_h = height - h;
    avg_filter_tuples =
        global->filters_built[rev_h] == 0
            ? 0
  ...
  platform_log("---------------------------------------------------------------"
               "---------------------\n");
  platform_log("| height | space recs | tuples reclaimed in sr | tuples "
               "reclaimed | tuples per rec |\n");
  platform_log("|--------|------------|------------------------|---------------"
               "---|----------------|\n");
...
void splinter_print_lookup_stats(splinter_handle *spl) {
  ...
  for (thr_i = 0; thr_i < MAX_THREADS; thr_i++) {
    for (h = 0; h <= height; h++) {
      ...
      global->filter_false_positives[h] +=
          spl->stats[thr_i].filter_false_positives[h];
  ...
  platform_log("---------------------------------------------------------------"
               "----------------------\n");
  platform_log("height   | avg filter lookups | avg false pos | false pos rate "
               "| avg branch lookups |\n");
  platform_log("---------|--------------------|---------------|----------------"
               "|--------------------|\n");
  ...
  for (h = 0; h <= height; h++) {
    ...
    if (lookups == 0) {
      ...
      avg_branch_lookups =
          init_fraction(global->branch_lookups[rev_h], lookups);
    }
    ...
    if (filter_negatives == 0) {
      ...
      false_positives_in_revision = init_fraction(
          global->filter_false_positives[rev_h], filter_negatives);
    }
    platform_log(
        "%8u | " FRACTION_FMT(18, 2) " | " FRACTION_FMT(
            13, 4) " | " FRACTION_FMT(14, 4) " | " FRACTION_FMT(18, 4) "\n",
...
void splinter_print_lookup(splinter_handle *spl, char *key) {
  ...
  // look in memtables
  // if we want to point out it's just crappy debug code it needs comments
  // saying that
  uint64 mt_gen_start = memtable_generation(spl->mt_ctxt);
  uint64 mt_gen_end = memtable_generation_retired(spl->mt_ctxt);
  for (uint64 mt_gen = mt_gen_start; mt_gen != mt_gen_end; mt_gen--) {
    ...
    if (found) {
      ...
      platform_log(
          ...
          key_str, root_addr, mt_gen, memtable_is_compacted, message_str);
  ...
  for (uint16 h = height; h > 0; h--) {
    ...
    if (found) {
      ...
      platform_log("Key %s found in node %lu pivot %u with data %s\n", key_str,
                   node->disk_addr, pivot_no, message_str);
      found = FALSE;
    } else {
      for (uint16 branch_no = pdata->start_branch;
           branch_no != splinter_end_branch(spl, node);
...
uint64 splinter_branch_count_num_tuples(splinter_handle *spl, page_handle *node,
                                        uint16 branch_no) {
  uint16 num_children = splinter_num_children(spl, node);
  uint64 num_tuples = 0;
  for (uint16 pivot_no = 0; pivot_no < num_children; pivot_no++) {
...
uint64 splinter_branch_extent_count(splinter_handle *spl, page_handle *node,
                                    uint16 branch_no) {
  splinter_branch *branch = splinter_get_branch(spl, node, branch_no);
  return btree_extent_count(spl->cc, &spl->cfg.btree_cfg, branch->root_addr);
}

bool splinter_node_print_branches(splinter_handle *spl, uint64 addr,
                                  void *arg) {
  page_handle *node = splinter_node_get(spl, addr);
...
bool splinter_node_print_extent_count(splinter_handle *spl, uint64 addr,
                                      void *arg) {
  page_handle *node = splinter_node_get(spl, addr);
...
void splinter_config_init(splinter_config *splinter_cfg, data_config *data_cfg,
                          log_config *log_cfg, uint64 memtable_capacity,
                          uint64 fanout, uint64 max_branches_per_node,
                          uint64 btree_rough_count_height, uint64 page_size,
                          uint64 extent_size, uint64 filter_remainder_size,
                          uint64 filter_index_size, uint64 reclaim_threshold,
                          uint64 use_log, uint64 use_stats) {
  ...
  // FIXME: [yfogel 2020-07-01] will we want this as a function (for tests?)
  {
    ...
    memmove(splinter_cfg->range_data_cfg.min_key, data_cfg->min_key,
            sizeof(data_cfg->min_key));
    memmove(splinter_cfg->range_data_cfg.max_key, data_cfg->max_key,
            sizeof(data_cfg->max_key));
  }
  ...
  btree_config_init(&splinter_cfg->btree_cfg, splinter_cfg->data_cfg,
                    data_type_point, btree_rough_count_height,
  ...
  btree_config_init(&splinter_cfg->range_btree_cfg,
                    &splinter_cfg->range_data_cfg, data_type_range,
                    btree_rough_count_height, splinter_cfg->page_size,
  ...
  uint64 pages_per_extent = splinter_cfg->extent_size / splinter_cfg->page_size;
...
size_t splinter_get_scratch_size() { return sizeof(splinter_task_scratch); }
