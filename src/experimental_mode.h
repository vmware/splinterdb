...
#define EXPERIMENTAL_MODE_STO_LEGACY          0
...
check_experimental_mode_is_valid()
{
   platform_assert(
      EXPERIMENTAL_MODE_TICTOC_DISK + EXPERIMENTAL_MODE_TICTOC_MEMORY
         + EXPERIMENTAL_MODE_TICTOC_COUNTER
         ...
         + EXPERIMENTAL_MODE_STO_SKETCH_LAZY + EXPERIMENTAL_MODE_STO_LEGACY + EXPERIMENTAL_MODE_MVCC_DISK
...
print_current_experimental_modes()
{
   ...
   if (EXPERIMENTAL_MODE_STO_LEGACY) {
      platform_default_log("EXPERIMENTAL_MODE_STO_LEGACY\n");
   }
