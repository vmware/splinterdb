...
#define EXPERIMENTAL_MODE_TICTOC_HASHTABLE  0
...
#define EXPERIMENTAL_MODE_STO_HASHTABLE     0
...
#define EXPERIMENTAL_MODE_MVCC_HASHTABLE    0
...
typedef uint32 txn_timestamp;
   ...
   || EXPERIMENTAL_MODE_MVCC_HASHTABLE || EXPERIMENTAL_MODE_MVCC_SKETCH
...
check_experimental_mode_is_valid()
{
   platform_assert(
      EXPERIMENTAL_MODE_TICTOC_DISK + EXPERIMENTAL_MODE_TICTOC_MEMORY
         + EXPERIMENTAL_MODE_TICTOC_COUNTER + EXPERIMENTAL_MODE_TICTOC_HASHTABLE
         + EXPERIMENTAL_MODE_TICTOC_SKETCH + EXPERIMENTAL_MODE_STO_DISK
         + EXPERIMENTAL_MODE_STO_MEMORY + EXPERIMENTAL_MODE_STO_COUNTER
         + EXPERIMENTAL_MODE_STO_HASHTABLE + EXPERIMENTAL_MODE_STO_SKETCH
         + EXPERIMENTAL_MODE_MVCC_DISK + EXPERIMENTAL_MODE_MVCC_MEMORY
         + EXPERIMENTAL_MODE_MVCC_COUNTER + EXPERIMENTAL_MODE_MVCC_HASHTABLE
         + EXPERIMENTAL_MODE_MVCC_SKETCH + EXPERIMENTAL_MODE_2PL_NO_WAIT
...
print_current_experimental_modes()
{
   ...
   if (EXPERIMENTAL_MODE_TICTOC_HASHTABLE) {
      platform_default_log("EXPERIMENTAL_MODE_TICTOC_HASHTABLE\n");
   }
   ...
   if (EXPERIMENTAL_MODE_STO_HASHTABLE) {
      platform_default_log("EXPERIMENTAL_MODE_STO_HASHTABLE\n");
   }
   ...
   if (EXPERIMENTAL_MODE_MVCC_HASHTABLE) {
      platform_default_log("EXPERIMENTAL_MODE_MVCC_HASHTABLE\n");
   }
