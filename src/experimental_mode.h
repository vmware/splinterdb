...
print_current_experimental_modes()
{
   ...
   platform_default_log("EXPERIMENTAL_MODE_STO_SKETCH: %d\n",
                        EXPERIMENTAL_MODE_STO_SKETCH);
   platform_default_log("EXPERIMENTAL_MODE_STO_MEMORY: %d\n",
                        EXPERIMENTAL_MODE_STO_MEMORY);
}
