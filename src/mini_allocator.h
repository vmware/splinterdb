...
uint64 mini_allocator_init(mini_allocator *mini, cache *cc, data_config *cfg,
                           uint64 meta_head, uint64 meta_tail,
                           uint64 num_batches, page_type type);
...
uint64 mini_allocator_extent_count(cache *cc, page_type type, uint64 meta_head);
...
static inline uint64 mini_allocator_meta_tail(mini_allocator *mini) {
