...
# #############################################################################
# Unit Stress Tests - Developed as a result of bug triage & reproductions.
# #############################################################################
...
function run_fast_unit_tests() {
   ...
   "$BINDIR"/unit/task_system_test $use_shmem --num-normal-bg-threads 4 --num-memtable-bg-threads  2
