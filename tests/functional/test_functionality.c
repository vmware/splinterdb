                   ...
                   uint32           max_async_inflight)
{
   ...
   platform_memfrag memfrag_spltables;
   memfrag_init(&memfrag_spltables, spl_tables, num_tables);

   test_splinter_shadow_tree **shadows =
      TYPED_ARRAY_ZALLOC(hid, shadows, num_tables);
   platform_memfrag memfrag_shadows;
   memfrag_init(&memfrag_spltables, shadows, num_tables);
   ...
   memfrag_init(&memfrag_spltables, splinters, num_tables);
