 ...
 * context.
 */
static void test_async_callback(splinter_async_ctxt *spl_ctxt) {
 ...
 */
void async_ctxt_init(platform_heap_id hid,      // IN
 ...
 */
void async_ctxt_process_one(splinter_handle *spl,
                            test_async_lookup *async_lookup,
                            test_async_ctxt *ctxt, timestamp *latency_max,
 ...
 */
bool async_ctxt_process_ready(splinter_handle *spl,
                              test_async_lookup *async_lookup,
  ...
  while (count-- > 0) {
    ...
    async_ctxt_process_one(spl, async_lookup, ctxt, latency_max, process_cb,
                           process_arg);
  }
