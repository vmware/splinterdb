...
static int test_data_key_cmp(const data_config *cfg, const void *key1,
                             const void *key2) {
...
static void test_data_merge_tuples(const data_config *cfg, const void *key,
 ...
 *-----------------------------------------------------------------------------
 */
static void test_data_merge_tuples_final(const data_config *cfg,
                                         const void *key,       // IN
...
static message_type test_data_message_class(const data_config *cfg,
                                            const void *raw_data) {
...
static void test_data_key_to_string(const data_config *cfg, const void *key,
                                    char *str, size_t len) {
...
static void test_data_message_to_string(const data_config *cfg,
                                        const void *raw_data, char *str_p,
                                        size_t max_len) {
  const data_handle *data = raw_data;
...
static data_config config = {.key_size = 24,
                             .message_size = 24,
                             .min_key = {0},
                             .max_key = {0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
